          ...
          <table className="w-full border-separate border-spacing-0 text-sm">
            <thead>
              <tr className="bg-[#170707]/95">
                ...
                <th className="px-3 py-2.5 text-left font-semibold text-amber-300/70 border-b border-[#670201]/20 whitespace-nowrap hidden md:table-cell">Nhóm</th>
  ...
  return (
    <>
      <tr className="hover:bg-white/[0.02] transition-colors">
        ...
        <td className="px-3 py-2.5 border-b border-white/5 hidden md:table-cell">
      ...
      {expanded && (
        <tr>
          <td colSpan={6} className="p-0">
            <div className="p-4 bg-black/20 space-y-2 text-xs">
              {t.usage_detail && (
...
function TemplateFormFields({
  mode, template, setTemplate, inputCls, labelCls,
}: {
  mode: 'add' | 'edit';
