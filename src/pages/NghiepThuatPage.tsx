  ...
  return (
    <section className="space-y-3">
      ...
      <div className="rounded-xl border border-amber-500/15 bg-amber-500/[0.03] p-3">
        <p className="text-xs text-amber-200/50 italic">Danh sách này chỉ dành cho Quản trị viên. Thông tin kỹ năng của người chơi là dữ liệu bảo mật.</p>
      </div>
...
export default function NghiepThuatPage() {
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-6">
      ...
      {/* Skill Listing — Admin Only */}
      {isAdmin && <SkillListSection isAdmin={isAdmin} />}
